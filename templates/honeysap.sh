#! /bin/sh
### BEGIN INIT INFO
# Provides:          {{ honeysap_service }}
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: HoneySAP initscript
# Description:       HoneySAP.
### END INIT INFO
...
DAEMON={{ honeysap_daemon }}
DAEMON_ARGS="--config-file={{ honeysap_config_file }}"
PIDFILE=/var/run/$NAME.pid
SCRIPTNAME=/etc/init.d/$NAME
CHUID={{ honeysap_username }}
